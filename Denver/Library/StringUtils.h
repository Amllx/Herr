...
Int32 CopyMem(VoidPtr src, VoidPtr dst, SizeT len); /* copies a memory region to another using a size as our scope. */
VoidPtr SetMem(VoidPtr dst, Char val, SizeT len); /* Sets the memory region to a size with a value */
